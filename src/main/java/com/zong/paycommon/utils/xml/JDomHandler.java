...
public class JDomHandler {
    ...
    private static final Logger LOGGER = Logger.getLogger(JDomHandler.class);

    public Document addNodeValueWithCheckAllPathNodes(String parentElementPath, String elementName, String value) throws JDOMException, JDomHandlerException {
        checkPathNodes(parentElementPath);
        addNodeValue(parentElementPath, elementName, value);
        return doc;
    }
     ...
     *             添加了错误处理机制，与容错机制
     **/
    public Document addNodeValue(String parentElementPath, String elementName, String value) throws JDomHandlerException, JDOMException {
     ...
     * @throws JDomHandlerException
     **/
    public String getNodeAttribute(String path,String attribute) throws JDomHandlerException, JDOMException {
     ...
     * @throws JDomHandlerException
     **/
    public void addNodeAttribute(String path, String attributeName, String value) throws JDomHandlerException, JDOMException {
        Element visitElement = null;
        visitElement = (Element) XPath.selectSingleNode(doc,path);
        if(visitElement != null){
    ...
    public Document setNodeAttribute(String path, String attributeName, String attributeVaule){
        Element visitElement = null;
        try{
            visitElement = (Element) XPath.selectSingleNode(doc,path);
            visitElement.setAttribute(attributeName, attributeVaule);
        }catch (Exception e){
            LOGGER.error(e);
        }
        return doc;
    ...
    public Document setNodeValues(String path, String nodeName, String value) throws JDOMException, JDomHandlerException {
        if (hasNode(path + "/" + nodeName)) {
            ...
            addNodeValue(path, nodeName, value);
        }
        return doc;
    }
