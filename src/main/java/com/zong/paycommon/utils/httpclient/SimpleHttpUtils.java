...
public class SimpleHttpUtils {
     ...
     */
    public static String httpRequest(String url, Map<String, String> parmas, String method,
                                     String charSet, Map<String, String> headers) {
        SimpleHttpParam param = new SimpleHttpParam(url);
        if (param != null) {
            param.setParameters(parmas);
        }
        if (headers != null) {
    ...
    public static SimpleHttpResult httpRequest(SimpleHttpParam httpParam){
        ...
        boolean sslVerrify = httpParam.isSslVerify();
        ...
        boolean ignoreContextIfUnsuccess = httpParam.isIgnoreContentIfUnsuccess();
        ...
        try{
            ...
            setSSLSocketFactory(urlConn, sslVerrify, hostnameVerify, trustKeyStore,clientKeyStore);
            ...
            Map<String, List<String>> resoponseHeaders = urlConn.getHeaderFields();
            String contentType = urlConn.getContentType();

            SimpleHttpResult result = new SimpleHttpResult(responseCode);
            result.setHeaders(resoponseHeaders);
            result.setContentType(contentType);

            if(responseCode != 200 && ignoreContextIfUnsuccess){
                return  result;
            }
